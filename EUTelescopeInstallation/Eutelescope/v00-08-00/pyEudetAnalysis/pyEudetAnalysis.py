...
HitProb_1_cluster,HitProb_2_cluster,HitProb_3_cluster,HitProb_4_cluster = ClusterHitProb(aDataSet,6)
 
h1_style(HitProb_1_cluster)
h1_style(HitProb_2_cluster)
h1_style(HitProb_3_cluster)
h1_style(HitProb_4_cluster)
...
can7 = TCanvas()
can7.cd()
HitProb_1_cluster.Draw("colz")
 
can8 = TCanvas()
can8.cd()
HitProb_2_cluster.Draw("colz")
 
can9 = TCanvas()
can9.cd()
HitProb_3_cluster.Draw("colz")
 
can10 = TCanvas()
can10.cd()
HitProb_4_cluster.Draw("colz")
...
HitProb_1_track,HitProb_2_track,HitProb_3_track,HitProb_4_track = TrackHitProb(aDataSet,6)

h1_style(HitProb_1_track)
h1_style(HitProb_2_track)
h1_style(HitProb_3_track)
h1_style(HitProb_4_track)
...
if method_name == "QWeighted" :
    ...
    can7.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_1_cluster_QWeighted.png")
    can8.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_2_cluster_QWeighted.png")
    can9.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_3_cluster_QWeighted.png")
    can10.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_4_cluster_QWeighted.png")
    ...
    can12.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_1_track_QWeighted.png")
    can13.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_2_track_QWeighted.png")
    can14.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_3_track_QWeighted.png")
    can15.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/QWeighted/HitProb_4_track_QWeighted.png")
    ...
    can7.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_1_cluster_DigitalCentroid.png")
    can8.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_2_cluster_DigitalCentroid.png")
    can9.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_3_cluster_DigitalCentroid.png")
    can10.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_4_cluster_DigitalCentroid.png")
    ...
    can12.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_1_track_DigitalCentroid.png")
    can13.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_2_track_DigitalCentroid.png")
    can14.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_3_track_DigitalCentroid.png")
    can15.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/DigitalCentroid/HitProb_4_track_DigitalCentroid.png")
    ...
    can7.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_1_cluster_maxTOT.png")
    can8.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_2_cluster_maxTOT.png")
    can9.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_3_cluster_maxTOT.png")
    can10.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_4_cluster_maxTOT.png")
    ...
    can12.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_1_track_maxTOT.png")
    can13.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_2_track_maxTOT.png")
    can14.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_3_track_maxTOT.png")
    can15.SaveAs("/afs/cern.ch/work/a/apequegn/public/DESY_TB_DATA_02_07-06-2013_results/pyEudetAnalysisPlots/maxTOT/HitProb_4_track_maxTOT.png")
...
resX.Write()
resY.Write()
HitProb_1_cluster.Write()
HitProb_2_cluster.Write()
HitProb_3_cluster.Write()
HitProb_4_cluster.Write()
