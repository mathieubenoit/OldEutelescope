...
aDataSet = EudetData("/VertexScratch/TB_Data/DESY_TB_DATA_August2013_results/tbtrack/tbtrackrun000059.root",5000.0,2)
...
resr,rest = Perform3StepAlignment(aDataSet,[[0,360],[0,360],[0,360],[-0.5,0.5],[-0.5,0.5]],10000,10,0.15,0.15)
# resr,rest = Perform3StepAlignment(aDataSet,[[0,360],[0,360],[0,360],[-0.5,0.5],[-0.5,0.5]],aDataSet.p_nEntries,1,0.5,0.5)
# resr,rest = Perform3StepAlignment(aDataSet,[[0,360],[0,360],[0,360],[-0.5,0.5],[-0.5,0.5]],aDataSet.p_nEntries,1)
...
#     out = TFile("%s/run59/QWeighted/output_rootfile_QWeighted_firingFreq001_run00059_distance%i.root"%(PlotPath,distance), "recreate")
    canhot.SaveAs("%s/run59/QWeighted/histo_hot_QWeighted2.pdf"%PlotPath)
    canfreq.SaveAs("%s/run59/QWeighted/histo_freq_QWeighted2.pdf"%PlotPath)
    cancorx.SaveAs("%s/run59/QWeighted/corx_QWeighted2.pdf"%PlotPath)
    cancory.SaveAs("%s/run59/QWeighted/cory_QWeighted2.pdf"%PlotPath)
#     cancorx_Test.SaveAs("%s/run59/QWeighted/corx_Test_QWeighted2.pdf"%PlotPath)
#     cancory_Test.SaveAs("%s/run59/QWeighted/cory_Test_QWeighted2.pdf"%PlotPath)
    ...
    cClusterSizeCounter.SaveAs("%s/run59/QWeighted/ClusterSizeCounter2.pdf"%PlotPath)
    cClusterSizeCounter_percent.SaveAs("%s/run59/QWeighted/ClusterSizeCounter_percent2.pdf"%PlotPath)
...
#     canvasTest_TOT4.SaveAs("%s/run59/QWeighted/TOT4_landaugausFit.pdf"%PlotPath)
    ...
    #out = TFile("%s/DigitalCentroid/output_rootfile_DigitalCentroid_firingFreq001_run00059.root"%PlotPath, "recreate")
    out = TFile("%s/run59/DigitalCentroid/output_rootfile_DigitalCentroid_firingFreq001_run00059_distance%i.root"%(PlotPath,distance), "recreate")
...
#     canvasTest_TOT4.SaveAs("%s/run59/DigitalCentroid/TOT4_landaugausFit.pdf"%PlotPath)
    ...
    #out = TFile("%s/run59/run59/maxTOT/output_rootfile_maxTOT_firingFreq001_run00059.root"%PlotPath, "recreate")
    out = TFile("%s/run59/maxTOT/output_rootfile_maxTOT_firingFreq001_run00059_distance%i.root"%(PlotPath,distance), "recreate")
...
#     canvasTest_TOT4.SaveAs("%s/run59/maxTOT/TOT4_landaugausFit.pdf"%PlotPath)
    ...
    out = TFile("%s/run59/EtaCorrection/output_rootfile_EtaCorrection_firingFreq001_run00059_distance%i.root"%(PlotPath,distance), "recreate")
#     out = TFile("%s/run59/EtaCorrection/output_rootfile_EtaCorrection_firingFreq001_run00059_distance%i_sigma%i.root"%(PlotPath,distance,sigma*1000), "recreate")
