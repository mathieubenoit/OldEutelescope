...
n_tracks_in = ComputeDetectorAcceptance(aDataSet,6,0.020)
...
#     out = TFile("%s/QWeighted/output_rootfile_QWeighted_firingFreq001_run000131.root"%(PlotPath,RunNumber), "recreate")
    ...
    canvas_resY_s4x2y2.SaveAs("%s/QWeighted/resY_s4x2y2.png"%(PlotPath,RunNumber))
...
#     canvasTest_TOT4.SaveAs("%s/Run%i/QWeighted/TOT4_landaugausFit.pdf"%(PlotPath,RunNumber))
    ...
    canvas_resY_s4x2y2.SaveAs("%s/DigitalCentroid/resY_s4x2y2.png"%(PlotPath,RunNumber))
